package com.thinkVendor.demoone.exception;
...
public class CloudVendorExceptionHandler {
    ...
    public ResponseEntity<Object> handlerNotFoundException(CloudVendorNotFoundException cloudVendorNotFoundException){
